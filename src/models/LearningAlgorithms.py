...
# Updated by Efthimios Vlahos on 9-08-2023
...
class ClassificationAlgorithms:
    ...
    #         raise ValueError(
    #             "The dataset contains NaN values which might cause issues."
    #         )
    ...
    #         knn = GridSearchCV(
    #             KNeighborsClassifier(algorithm="brute"),  # Set algorithm to 'brute'
    #             tuned_parameters,
    #             cv=5,
    #             scoring=make_scorer(accuracy_score),  # Use make_scorer for scoring
    #         )
    #     else:
    ...
    #     # If gridsearch is active, print the best parameters
    #     if gridsearch and print_model_details:
    #         print(knn.best_params_)

    #     # If using gridsearch, get the best estimator
    #     if gridsearch:
